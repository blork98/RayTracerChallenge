#ifndef TRANSFORM_TESTS_
#define TRANSFORM_TESTS_
...
//	Given p ? point(0, 0, 1)
//	And half_quarter ? rotation_y(? / 4)
//	And full_quarter ? rotation_y(? / 2)
//	Then half_quarter * p = point(?2 / 2, 0, ?2 / 2)
//	And full_quarter * p = point(1, 0, 0)

//Scenario: Rotating a point around the z axis
//	Given p ? point(0, 1, 0)
//	And half_quarter ? rotation_z(? / 4)
//	And full_quarter ? rotation_z(? / 2)
